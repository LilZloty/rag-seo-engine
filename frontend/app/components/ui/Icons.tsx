// Example Store SVG Icon Components
// Professional icons to replace all emoji usage
...
// Refresh icon (alias for SyncIcon for backward compatibility)
export const RefreshIcon: React.FC<IconProps> = (props) => <SyncIcon {...props} />;
...
// Library/book icon
export const LibraryIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        className={className}
        width={size}
        height={size}
...
// Chip/chunks icon
export const ChipIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        className={className}
        width={size}
        height={size}
...
export const CarIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        ...
        strokeWidth="2"
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 17h8m-8 0a2 2 0 11-4 0 2 2 0 014 0zm8 0a2 2 0 11-4 0 2 2 0 014 0zM3 9l3-3h12l3 3M3 9v8h2M3 9h18m0 0v8h-2" />
    </svg>
);

// Gear/settings icon
export const GearIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        className={className}
        width={size}
        height={size}
...
// Fire/hot icon
export const FireIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        className={className}
        width={size}
        height={size}
...
export const TemplateIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        className={className}
        width={size}
        height={size}
...
export const MousePointerIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        className={className}
        width={size}
        height={size}
        ...
        strokeWidth="2"
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3zm10 10l6 6" />
    </svg>
);

// Target/bullseye icon for CTR optimization
...
// Device/mobile icon
export const DeviceIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg
        className={className}
        width={size}
        height={size}
...
// Collection icon
export const CollectionIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
...
// Columns icon
export const ColumnsIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
    <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />
    </svg>
);

// Settings icon (alias for GearIcon)
export const SettingsIcon: React.FC<IconProps> = (props) => <GearIcon {...props} />;
